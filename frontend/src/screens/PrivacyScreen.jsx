    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #2563eb 0%, #1e40af 100%)', padding: '40px 20px' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', marginBottom: '24px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.08)' }}>
          ...
          <p style={{ color: '#4a5568', lineHeight: '1.7', fontSize: '1rem', marginBottom: '16px' }}>At PledgedHub, we respect your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, store, and protect your information.</p>
          <p style={{ color: '#4a5568', lineHeight: '1.7', fontSize: '1rem', margin: '0' }}>By using PledgedHub, you agree to the collection and use of information in accordance with this policy.</p>
        </div>
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', marginBottom: '24px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.08)' }}>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.08)' }}>
          ...
          <div style={{ padding: '20px', background: 'rgba(139, 92, 246, 0.08)', borderRadius: '12px' }}>
            <p style={{ margin: '0 0 8px', color: '#1a202c', fontWeight: '600' }}>PledgedHub Support</p>
