...
- Include subtle reference to 'Omukwano' (friendship/unity) values
...
async function generateChatResponse(userMessage, context = '', dataContext = '') {
    ...
    try {
        ...
        const prompt = `You are a helpful AI assistant for the Omukwano Pledge Management System, a platform used in Uganda for managing church and community donations/pledges.
...
2. Relates to the Omukwano Pledge system when relevant
